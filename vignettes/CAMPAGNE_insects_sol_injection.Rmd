...
insecte_sol_obs <- range_read(sheet_address,
                              sheet = "insecte_sol_observation", encoding = "UTF-8")
...
Note that soil insects are peculiar, in that unlike other datasets in coleo they produce two kinds of data. First, soil insects which are sorted to species -- and second, soil insects which are not identified to species. 
