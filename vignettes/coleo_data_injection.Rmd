...
```{r}
camp_injected_imaginary <- coleo_execute_injection(requests_imaginary)
...
```{r}
trap_response_imaginary <- trap_inject_imaginary |> coleo_execute_injection()
...
```{r}
repere_response <- coleo_execute_injection(repere_inject_imaginary)
...
samp_response <- coleo_execute_injection(samp_inject_imaginary)
