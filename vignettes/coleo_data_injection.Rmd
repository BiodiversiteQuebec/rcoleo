...
imaginary_insects <- tibble::tribble(
  ~site_code, ~campaign_type, ~campaign_date_opened, ~campaign_date_closed, ~observation_date, ~observation_is_valid, ~trap_code, ~land_lat, ~land_lon, ~sample_code, ~campaign_technician_1, ~ref_taxa_rank, ~ref_taxa_tsn, ~ref_taxa_name, ~observation_taxa_name, ~observation_variable, ~observation_value, ~observation_notes,
      ...
      "111_777_E03", "insectes_sol",          "2020-06-08",          "2020-06-30",      "2020-06-30",                  TRUE,     "A-N1",  50.56699, -74.44866,  "2020-0097",       "Legolas, Gimli",       "espèce",            9999, "Fake_beetleB",         "Fake_beetleB",           "abondance",                  6,                NA,
      "111_777_E03", "insectes_sol",          "2020-06-08",          "2020-06-30",      "2020-06-30",                  TRUE,     "A-N1",  50.56699, -74.44866,  "2020-0097",       "Legolas, Gimli",       "espèce",            9999, "Fake_beetleC",         "Fake_beetleC",           "abondance",                  10,               "incomplet",
      "111_777_E03", "insectes_sol",          "2020-06-08",          "2020-06-30",      "2020-06-30",                  TRUE,     "A-N1",  50.56699, -74.44866,  "2020-0097",       "Legolas, Gimli",       "espèce",            9999, "Fake_beetleR",         "Fake_beetleR",           "abondance",                  11,               NA,
      ...
      "111_777_E03", "insectes_sol",          "2020-06-30",          "2020-07-21",      "2020-07-21",                  TRUE,    "B-NE1",  50.56698,  -74.4487,  "2020-0105",       "Legolas, Gimli",  "sous-classe",            9999, "Fake_beetleL",         "Fake_beetleL",           "abondance",                  3,                "not sure about one",
      "111_777_E03", "insectes_sol",          "2020-06-08",          "2020-06-30",      "2020-06-30",                  TRUE,    "B-NE1",  50.56698,  -74.4487,  "2020-0098",       "Legolas, Gimli",       "classe",            9999, "Fake_beetleG",         "Fake_beetleG",           "abondance",                  1,                NA,
      "111_777_E03", "insectes_sol",          "2020-06-08",          "2020-06-30",      "2020-06-30",                  TRUE,    "B-NE1",  50.56698,  -74.4487,  "2020-0098",       "Legolas, Gimli",       "espèce",            9999, "Fake_beetleH",         "Fake_beetleH",           "abondance",                  1,                NA
  )
...
# 
# obs_query <- obs_inject_imaginary |> 
#   mutate(dl_id = list(coleo_request_general(date_obs = date_obs,
#                                             #sample_id = sample_id,
#                                             #is_valid = is_valid, 
#                                             campaign_id = campaign_id, endpoint = "observations")))
# 
# obs_query$dl_id[[1]]
# obs_query
# httr2::resp_body_json(obs_query$dl_id[[1]])
# 
# obs_query |> 
#   mutate(observation_id = coleo_extract_id(dl_id)) |> glimpse()
```

```{r, eval = FALSE}
obs_response <- coleo_injection_execute(obs_inject_imaginary)

obs_response |> glimpse()

obs_response |> coleo_injection_final()
```
...
however, this doesn't work for every table; why is that? 
