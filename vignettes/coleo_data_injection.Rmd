...
First, we format the data for injection:
...
the function `coleo_prep_input_data` has automaticaly obtained cell ID and removed the cell_code, renamed the columns, reformatted the spatial information, and nested any unnecessary columns as "data".
...
First we use `coleo_prep_input_data` to prepare the campaign data
