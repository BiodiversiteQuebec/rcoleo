...
```
## Error in str(taxa_list, max.level = 3): object 'taxa_list' not found
```
...
```
## Error in list2(...): object 'taxa_list' not found
```
...
glimpse(corrections)
```
* **7.4.1** Étape facultative, elle permet de changer des noms de colonnes si ils ne sont pas écrits de la même façon que Coléo.
