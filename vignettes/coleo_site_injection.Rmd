...
This second step is important. This lets us access interesting information in the response. for example, we can extract the ID of the cell we just injected:
