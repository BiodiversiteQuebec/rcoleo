...
df_test_2_extra_cols <- data.frame(
  ...
  testthat::expect_equal(names(out_tbl_extra_4), c("col_1", "observations_extra"))
  ...
  testthat::expect_identical(out_tbl_extra_1[[2]], exp_json_two_variables)

  ### Test for multiple extra columns (table)
df_test_3_extra <- data.frame(
  ...
  testthat::expect_equal(names(out_tbl_extra_cols_1), c("col_1", "observations_extra_variable_1", "observations_extra_value_1", "environments_extra"))
})
